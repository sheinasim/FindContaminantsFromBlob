...
contaminantTigs[['contig', 'phylum', 'class', 'order', 'family', 'genus', 'species', 'length']].to_csv(contaminants_outfile, sep='\t', index=False, header=True)
keeperTigs[['contig', 'phylum', 'length']].to_csv(keepers_outfile, sep='\t', index=False, header=True)
